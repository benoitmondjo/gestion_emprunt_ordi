...
import { FiMoreVertical, FiEye, FiCheckCircle, FiEdit2, FiTrash2 } from "react-icons/fi";
...
// Menu déroulant d'actions : Voir détails, Marquer comme retourné, Modifier, Supprimer
    ...
    <div className="relative inline-block text-left" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 z-10 mt-1 w-48 bg-white border border-gray-200 rounded-lg shadow-lg py-1">
          ...
          <button
            onClick={() => handleAction(onRetourClick)}
            className="flex items-center gap-2 w-full px-3 py-2 text-sm text-gray-700 font-inter hover:bg-gray-50 cursor-pointer"
          >
