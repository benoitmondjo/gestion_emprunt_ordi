// On importe l'icône depuis react-icons
import { FiMonitor, FiPlus } from "react-icons/fi";

// On définit le typage des props attendues
interface HeaderOrdinateursProps {
  onAjouterClick?: () => void; // Optionnel, pour brancher l'action du bouton plus tard
}

// Composant header constitué de : une icôn, un titre/sous-titre à gauche, et un bouton d'action à droite
export default function HeaderOrdinateurs({
  onAjouterClick,
}: HeaderOrdinateursProps) {
  return (
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-(--texte-gray-1) font-inter">
            Liste des ordinateurs disponibles dans le système
          </p>
        </div>
      </div>
